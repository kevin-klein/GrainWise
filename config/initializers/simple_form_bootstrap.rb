...
SimpleForm.setup do |config| # rubocop:disable Metrics/BlockLength
  ...
  config.wrappers :left_right_select, tag: "div", class: "row mb-3", error_class: "form-group-invalid",
  ...
  config.wrappers :vertical_collection, item_wrapper_class: "form-check", item_label_class: "form-check-label",
    tag: "fieldset", class: "row mb-3", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "legend", class: "col-form-label col-sm-2 pt-0" do |ba|
      ba.use :label_text
    end
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: "form-check form-check-inline",
    ...
    b.wrapper tag: "div", class: "col-sm-10" do
      b.use :input, class: "form-control", error_class: "is-invalid", valid_class: "is-valid"
    end
    b.use :full_error, wrap_with: {tag: "div", class: "invalid-feedback d-block"}
    b.use :hint, wrap_with: {tag: "small", class: "form-text text-muted"}
  ...
  config.wrappers :horizontal_boolean, tag: "div", class: "form-group row", error_class: "form-group-invalid",
    ...
    b.wrapper :grid_wrapper, tag: "div", class: "col-sm-9" do |wr|
      wr.wrapper :form_check_wrapper, tag: "div", class: "mb-3 row" do |bb|
        b.wrapper tag: "div", class: "col-sm-10" do
          b.use :input, class: "form-control", error_class: "is-invalid", valid_class: "is-valid"
        end
        bb.use :label, class: "form-check-label"
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: "mb-3 row", item_label_class: "form-check-label",
